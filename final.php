<?php
    ...
    if($_SESSION["erreur"] == 10) {
        ...
        $ajout = array($_SESSION["joueur1"], $_SESSION["joueur2"], $_SESSION["mot"], 1, $_SESSION["nbcoups"]);
        ...
        $ajout = array($_SESSION["joueur1"], $_SESSION["joueur2"], $_SESSION["mot"], 2, $_SESSION["nbcoups"]);
        $statement = $bdd->prepare("INSERT INTO partie (nom_joueur1, nom_joueur2, mot, victoire, nb_coup) VALUES (?, ?, ?, ?, ?);");
        $statement->execute($ajout);
    }
?>
